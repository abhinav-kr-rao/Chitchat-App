             ...
             items-center justify-between max-sm:flex-col-reverse rounded-lg">
                <form onSubmit={handleSubmit} className=' flex flex-col gap-5 p-10 flex-1'>
                    ...
                    <label htmlFor="avatar" className=' flex items-center gap-3 cursor-pointer'>
                        ...
                        <img src={selectedImg ? URL.createObjectURL(selectedImg) : "userLogo.png"} alt=""
                    ...
                    <input onChange={(e) => setName(e.target.value)} value={name} type="text" required placeholder='Your name' className=' p-2 border border-gray-500
                     rounded-md focus:outline-none focus:ring-2 focus:caret-violet-500'/>
                    <textarea onChange={(e) => setBio(e.target.value)} value={bio} name="bio" required placeholder='Write profile bio'
                        className=' p-2 border border-gray-500
                     rounded-md focus:outline-none focus:ring-2 focus:caret-violet-500' rows={4}></textarea>
                ...
                <img src={authUser?.profilePic || `/userLogo.png`} alt="logo"
